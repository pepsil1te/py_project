...
col = 10  # 10 колонн
row = 20  # 20 строк
s_width = 800  # ширина окна
s_height = 750  # высота окна
play_width = 300  # ширина игрового окна; 300/10 = 30 ширины на блок
play_height = 600  # высота игрового окна; 600/20 = 20 высоты на блок
block_size = 30  # размер блока

top_left_x = (s_width - play_width) // 2
top_left_y = s_height - play_height - 50

# текстовый файл со значениме рекорда
...
# индексы фигур для представления
...
class Piece(object):
    def __init__(self, x, y, shape):
        ...
        self.y = y
        self.shape = shape
        self.color = shape_colors[shapes.index(shape)]  # выбор цвета из списка
        self.rotation = 0
...
def main(window):
    ...
    draw_text_middle('You Lost', 40, (255, 255, 255), window) #проигрыш
    pygame.display.update()
...
def main_menu(window):
    run = True
    while run:
        draw_text_middle('Press any key to begin', 50, (255, 255, 255), window) #продолжение
        pygame.display.update()
